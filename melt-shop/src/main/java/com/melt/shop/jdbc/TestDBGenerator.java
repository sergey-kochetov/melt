...
public class TestDBGenerator {
    ...
    private static String generateProductDescription(String categoryName) {
        ...
        try {
            String[] desc = {};
            String[] options = {};
            Field fieldDesc = TestDBGenerator.class.getDeclaredField(staticFieldDescName);
            desc = (String[]) fieldDesc.get(TestDBGenerator.class);
            try {
                Field fieldDescOptions = TestDBGenerator.class.getDeclaredField(staticFieldDescOptionsName);
                options = (String[]) fieldDescOptions.get(TestDBGenerator.class);
    ...
    private static class Category implements Comparable<Category> {
        ...
        private List<Producer> createProducers() {
            ...
            try {
                Field field = TestDBGenerator.class.getDeclaredField(staticFieldName);
                String[] data = (String[]) field.get(TestDBGenerator.class);
